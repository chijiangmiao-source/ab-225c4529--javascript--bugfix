...
//
// Coordinates are decimal STRINGS: the app keeps every business integer in
// exact textual form (see src/exact.js) so values above 2**53 cannot be
// rounded before submission, uniqueness comparison or re-audit.
